...
{
    // stolen and adapted from QuickLZ source, http://www.quicklz.com/QuickLZ.cs
    public class QuickLZ
    {
        ...
        public uint QLZ_SCRATCH_DECOMPRESS
        {
            get
            {
                return _QLZ_SCRATCH_DECOMPRESS;
            }
        }
        ...
        #region Code taken from the original file

        private uint _QLZ_COMPRESSION_LEVEL = 1;
        private uint _QLZ_SCRATCH_COMPRESS = 1;
        private uint _QLZ_SCRATCH_DECOMPRESS = 1;

        private const int _QLZ_VERSION_MAJOR = 1;
        private const int _QLZ_VERSION_MINOR = 5;
        private const int _QLZ_VERSION_REVISION = 0;

        // Streaming mode not supported
        private const int _QLZ_STREAMING_BUFFER = 0;

        // Bounds checking not supported  Use try...catch instead
        private const int _QLZ_MEMORY_SAFE = 0;
        ...
        {
            int level = (int)QLZ_COMPRESSION_LEVEL;
            int src = 0;
